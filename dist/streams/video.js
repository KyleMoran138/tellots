...
var commander = require('../exchanger');
...
var bind = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, commander.send('streamon')];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
            ...
            case 3:
                ...
                return [2 /*return*/, _local.emitter];
        }
    });
}); };
var close = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, commander.send('streamoff')];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
